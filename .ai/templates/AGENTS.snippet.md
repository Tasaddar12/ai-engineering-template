<!--
Append this to the project's root CLAUDE.md. Do not replace an existing
CLAUDE.md with it.
...
survives in a crowded CLAUDE.md.
-->
...
| Path | Tier | You may |
|---|---|---|
| `.ai/intent/**` | `intent` | **Ask** — human authority |
...
changes in `.ai/intent/` — until then, raise the gap rather than acting on it.
