# Bundled supporting methods

These documents supply the detailed examples and procedures used by the local
agent roles. They are adapted from pinned sources identified in
...
The [agent catalog](../../agents/README.md) is the entry point, not a requirement
