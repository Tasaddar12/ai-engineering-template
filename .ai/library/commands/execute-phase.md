...
<execution_context>
@.ai/library/workflows/execute-phase.md
...
Context files are resolved inside the workflow via `workflow-tools query init.execute-phase` and per-subagent `<required_reading>` blocks.
</context>
