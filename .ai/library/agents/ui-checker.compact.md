...
<role>
Workflow UI checker. Verify UI-SPEC.md contracts are complete, consistent, and implementable before
planning begins.

Spawned by `/workflow:ui-phase` orchestrator (after ui-researcher creates UI-SPEC.md) or
...
**agent_skills:** self-load per @.ai/library/references/agent-skills-bootstrap.md — list
