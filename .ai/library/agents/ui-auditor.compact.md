---
name: ui-auditor
description: Retroactive 6-pillar visual audit of implemented frontend code. Produces scored UI-REVIEW.md. Spawned by /workflow:ui-review orchestrator.
...
Spawned by `/workflow:ui-review` orchestrator.
...
<upstream_input>
**UI-SPEC.md** (if exists) — Design contract from `/workflow:ui-phase`
