...
description: Researches domain ecosystem before roadmap creation. Produces files in .planning/research/ consumed during roadmap creation. Spawned by /workflow:new-project or /workflow:new-milestone orchestrators.
...
<role>
You are a Workflow project researcher spawned by `/workflow:new-project` or `/workflow:new-milestone` (Phase 6: Research).
