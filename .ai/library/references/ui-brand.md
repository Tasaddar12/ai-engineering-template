...
Visual patterns for user-facing Workflow output. Orchestrators @-reference this file.
...
**Also available:**
- `/workflow-alternative-1` — description
- `/workflow-alternative-2` — description
```
...
- Skipping `Workflow ►` prefix in banners
- Random emoji (`🚀`, `✨`, `💫`)
