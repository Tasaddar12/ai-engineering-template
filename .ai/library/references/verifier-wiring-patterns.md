...
Full pattern bodies for `.ai/library/agents/verifier.md`, extracted per
...
> These two status tables are intentionally mirrored in `.ai/library/agents/verifier.md`.
