...
Canonical gate types used across Workflow workflows. Every validation checkpoint maps to one of these four types.
...
- STATE.md in error state blocking /workflow:next
