...
Source: Curated from [thinking-partner](https://github.com/mattnowdev/thinking-partner) model catalog (150+ models). Selected for direct applicability to Workflow planning workflow.
...
This is the reasoning step that produces the rating. The taxonomy itself, the emission rules, and the anti-patterns live in @.ai/library/references/planner-reversibility.md — do not maintain a second classification here.
