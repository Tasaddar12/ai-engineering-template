...
Used when `plan-phase` spawns `planner` with `CHUNKED_MODE=true` (triggered by `--chunked`
...
supports it (#3777; see `.ai/library/workflows/plan-phase/steps/chunked-planning-mode.md` §8.5.2).
