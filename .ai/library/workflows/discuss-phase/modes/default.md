...
> **Lazy-loaded.** Read this file from `.ai/library/workflows/discuss-phase.md` when no
...
(see `.ai/library/references/thinking-partner.md` for signal list). If tradeoff detected:
...
Schema: read `.ai/library/workflows/discuss-phase/templates/checkpoint.json` for the
