...
{if HAS_SPIKES && !SPIKE_SKILL}  ◆ Raw spikes in .planning/spikes/ — consider `/workflow:spike --wrap-up` to package findings
{if HAS_SKETCHES && !SKETCH_SKILL}  ◆ Raw sketches in .planning/sketches/ — consider `/workflow:sketch --wrap-up` to package findings
...
Use template: .ai/templates/research-project/STACK.md
</output>
...
Use template: .ai/templates/research-project/FEATURES.md
</output>
...
Use template: .ai/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: .ai/templates/research-project/PITFALLS.md
</output>
