...
Provenance is recorded in [third-party notices](../THIRD-PARTY-NOTICES.md). Selected for applicability to debugging.
...
Return this after required verification confirms the fix; human-only acceptance still needs actual human observations.
