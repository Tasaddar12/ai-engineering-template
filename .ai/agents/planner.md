...
Contract changes and exact target wording are clear. A PLAN may always require
changes to any contract because it defines desired future state. Do not pre-land
