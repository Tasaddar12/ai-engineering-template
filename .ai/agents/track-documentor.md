...
Write only assigned documentation paths: `.md`, `.markdown`, `.rst` and `.adoc`
...
empty. Runtime YAML/configuration is outside runtime docs-fix scope.
...
documentation step under RULES. Runtime docs-fix workers return scoped edits
uncommitted for coordinator audit and commit; standalone authors commit their
own task work.
