...
Agent *behavior* lives in [`.claude/`](../.claude/); the project's *content*
lives here.
...
├── ROADMAP.md          Ordered phases. mode: full only; absent otherwise.
├── intent/             Why we're building this. Human authority.
