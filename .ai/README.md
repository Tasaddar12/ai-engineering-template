...
`project/agent-models.json` contains both provider maps. This repository retains the user's Sol/xhigh implementation override and Astra/xhigh reviews; fresh installations default routine development to Terra/high or Sonnet/high. Gate policy profiles contain recommendations but remain unconfigured until verified for the specific gate. This correction does not approve the proposed engine graph.
