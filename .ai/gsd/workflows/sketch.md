...
@.ai/gsd/references/sketch-theme-system.md
@.ai/gsd/references/sketch-variant-patterns.md
@.ai/gsd/references/sketch-interactivity.md
@.ai/gsd/references/sketch-tooling.md
</required_reading>
...
**b. Findings skills** — glob `./.claude/skills/sketch-findings-*/SKILL.md` and read any that exist, plus their `.ai/gsd/references/*.md`. These contain curated design decisions from prior wrap-ups.
...
**a.** Glob for `./.claude/skills/spike-findings-*/SKILL.md` and read any that exist, plus their `.ai/gsd/references/*.md`. These contain validated patterns and requirements.
