...
> **Lazy-loaded.** Read this file from `.ai/gsd/workflows/discuss-phase.md` when no
...
(see `.ai/gsd/references/thinking-partner.md` for signal list). If tradeoff detected:
...
Schema: read `.ai/gsd/workflows/discuss-phase/templates/checkpoint.json` for the
