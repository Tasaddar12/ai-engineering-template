...
Key references:
- @.ai/gsd/references/ui-brand.md (display patterns)
- @.ai/gsd/agents/gsd-user-profiler.md (profiler agent definition)
- @.ai/gsd/references/user-profiling.md (profiling reference doc)
</required_reading>
...
- The user-profiling reference doc at `.ai/gsd/references/user-profiling.md`
...
Reference: @.ai/gsd/references/user-profiling.md
