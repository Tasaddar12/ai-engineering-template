...
If the project uses git submodules, parse `SUBMODULE_PATHS` from `.gitmodules` exactly as `/gsd:quick` does (a fail-loud commit-time guard, applied per item at commit time — see `.ai/gsd/workflows/quick.md` Step 2 for the identical block, reused verbatim below):
...
@.ai/gsd/references/dispatch-isolation-gate.md and run its `Resolve
...
If `$RESUME_BATCH_ID` is set: read and execute `.ai/gsd/workflows/quick-batch/steps/resume-mode.md`.
...
Otherwise: read and execute `.ai/gsd/workflows/quick-batch/steps/batch-init.md`.
...
If `section_manifest` is `null` or `"research-phase"` is in its `included` list: read and execute `.ai/gsd/workflows/quick-batch/steps/research-phase.md`. Otherwise skip — do not read the file.
<!-- /gsd:section -->
...
Read and execute `.ai/gsd/workflows/quick-batch/steps/planner-wave.md`. It
...
per-item plan-checker loop (`.ai/gsd/workflows/quick-batch/steps/plan-checker-loop.md`)
...
Read and execute `.ai/gsd/workflows/quick-batch/steps/worktree-dispatch.md`.
...
Read and execute `.ai/gsd/workflows/quick-batch/steps/merge-wave.md`. Merges
...
If `section_manifest` is `null` or `"verification-wave"` is in its `included` list: read and execute `.ai/gsd/workflows/quick-batch/steps/verification-wave.md`. Otherwise skip — do not read the file.
<!-- /gsd:section -->
...
Read and execute `.ai/gsd/workflows/quick-batch/steps/completion.md`. Calls
