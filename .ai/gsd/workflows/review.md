...
If `section_manifest` is `null` or `"reviewer-instances-note-1"` is in its `included` list: read and execute `.ai/gsd/workflows/review/steps/reviewer-instances-note-1.md`. Otherwise skip — do not read the file.
<!-- /gsd:section -->
...
If `section_manifest` is `null` or `"reviewer-instances-note-2"` is in its `included` list: read and execute `.ai/gsd/workflows/review/steps/reviewer-instances-note-2.md`. Otherwise skip — do not read the file.
<!-- /gsd:section -->
...
`.ai/gsd/references/reviewer-instances.md`.
