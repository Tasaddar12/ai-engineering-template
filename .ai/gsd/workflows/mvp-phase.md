...
<required_reading>
@.ai/gsd/references/user-story-template.md
@.ai/gsd/references/spidr-splitting.md
@.ai/gsd/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@.ai/gsd/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@.ai/gsd/references/user-story-template.md`:
...
Run the SPIDR rules from `@.ai/gsd/references/spidr-splitting.md`. Briefly:
