...
<required_reading>
@.ai/gsd/references/ai-frameworks.md
...
```markdown
Read .ai/gsd/agents/gsd-framework-selector.md for instructions.
...
```markdown
Read .ai/gsd/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read .ai/gsd/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read .ai/gsd/agents/gsd-eval-planner.md for instructions.
