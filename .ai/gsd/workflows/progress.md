...
If `section_manifest` is `null` or `"mvp-display"` is in its `included` list: read and execute `.ai/gsd/workflows/progress/steps/mvp-display.md`. Otherwise skip — do not read the file.
<!-- /gsd:section -->
...
If `section_manifest` is `null` or `"forensic-audit"` is in its `included` list: read and execute `.ai/gsd/workflows/progress/steps/forensic-audit.md`. Otherwise skip — do not read the file.
<!-- /gsd:section -->
