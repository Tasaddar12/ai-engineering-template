...
**Compact Content Gate.** Read and follow `.ai/gsd/references/compact-content-gate.md` now — it states the `workflow.compact_content` check and the resolution rule this spine defers to. When it directs a Read, read `.ai/gsd/workflows/docs-update/detail/elaboration.md` in full before continuing past this point; its content elaborates on three steps below (sequential_generation, fix_loop, verify_only_report).
...
Exact iteration bookkeeping and the regression-halt report wording: `.ai/gsd/workflows/docs-update/detail/elaboration.md` § 2.
</step>
...
Exact table format and failure-detail wording: `.ai/gsd/workflows/docs-update/detail/elaboration.md` § 3.
</step>
