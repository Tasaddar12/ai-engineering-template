...
@.ai/gsd/references/dispatch-isolation-gate.md, the canonical statement of the
...
# as .ai/gsd/references/dispatch-isolation-gate.md does — this site declares that gate
...
#      decision.
#   3. Inline the gsd-executor ROLE DEFINITION: read `.ai/gsd/agents/gsd-executor.md`
...
- .ai/gsd/agents/gsd-executor.md (the ROLE DEFINITION you are executing — its steps
