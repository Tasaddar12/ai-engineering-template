...
If `section_manifest` is `null` or `"auto-advance-dispatch"` is in its `included` list: read and execute `.ai/gsd/workflows/discuss-phase-assumptions/steps/auto-advance-dispatch.md`. Otherwise skip — do not read the file.
<!-- /gsd:section -->
