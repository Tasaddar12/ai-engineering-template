...
<required_reading>
@.ai/gsd/references/common-bug-patterns.md
</required_reading>
...
@.ai/gsd/references/debugger-philosophy.md
...
Full step-by-step bodies for every technique below: @.ai/gsd/references/debugger-techniques.md
...
@.ai/gsd/references/debugger-bug-taxonomy.md
...
@.ai/gsd/references/debugger-repro-hardening.md
...
@.ai/gsd/references/debugger-semantic-recall.md
...
@.ai/gsd/references/thinking-models-debug.md
...
@.ai/gsd/references/debugger-sbfl.md
...
- Read @.ai/gsd/references/common-bug-patterns.md
...
@.ai/gsd/references/debugger-rca-branching.md
...
@.ai/gsd/references/debugger-fix-acceptance.md
...
@.ai/gsd/references/debugger-prevention.md
...
Returned when a fix-acceptance guardrail signal fails (see `@.ai/gsd/references/debugger-fix-acceptance.md`). Do **not** mark the session resolved.
