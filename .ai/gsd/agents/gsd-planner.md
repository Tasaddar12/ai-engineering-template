...
@.ai/gsd/references/mandatory-initial-read.md
...
**Project skills:** @.ai/gsd/references/project-skills-discovery.md
- Load `rules/*.md` as needed during **planning**.
- Ensure plans account for project skill patterns and conventions.

**agent_skills:** self-load per @.ai/gsd/references/agent-skills-bootstrap.md
</project_context>
...
@.ai/gsd/references/planner-source-audit.md for full format, examples, and gap-handling rules.
...
@.ai/gsd/references/planner-source-audit.md for constraint examples.
...
See @.ai/gsd/references/planner-guidance.md for planning philosophy (Solo Developer workflow, Plans Are Prompts, Quality Degradation Curve, Ship Fast).
...
**Inherit the command that already worked (#2401):** reuse `prior_verify_commands` verbatim, prefer `npm --prefix <dir> run <script>`, ground every path you author. @.ai/gsd/references/planner-verify-command-grounding.md
...
**Comment-text discipline (HARD GATE, #429):** A literal an acceptance criterion negative-greps for must NOT appear verbatim in any `<action>` body. Full rules + `<!-- planner-discipline-allow: LIT -->` allowlist + worked examples: @.ai/gsd/references/planner-antipatterns.md ("Comment-Text Discipline").
</comment_text_discipline>
...
See @.ai/gsd/references/planner-guidance.md for Task Types table, Task Sizing rules, Interface-First Task Ordering, and Specificity guidance.

## TDD Detection

**When `workflow.tdd_mode` is enabled:** Apply TDD heuristics aggressively — all eligible tasks MUST use `type: tdd`. Read @.ai/gsd/references/tdd.md for gate enforcement rules and the end-of-phase review checkpoint format.
...
See @.ai/gsd/references/planner-guidance.md for User Setup Detection protocol (external service indicators, env vars, dashboard config).

</task_breakdown>

<dependency_graph>

See @.ai/gsd/references/planner-guidance.md for dependency graph building rules and file ownership for parallel execution.
...
Full rules: @.ai/gsd/references/context-budget.md (Phase Sizing). Read before sizing.
...
See `.ai/gsd/references/planner-interface-context.md` for the full interface extraction guide.
...
See @.ai/gsd/references/planner-guidance.md for a worked example and the `must_haves` YAML format.
...
Three types: **checkpoint:human-verify (90%)**, **checkpoint:decision (9%)**, **checkpoint:human-action (1% - rare)**. Full "use for" criteria and XML templates for each: @.ai/gsd/references/checkpoints.md
...
@.ai/gsd/references/planner-antipatterns.md
...
<gap_closure_mode>
See `.ai/gsd/references/planner-gap-closure.md`. Load this file at the
start of execution when `--gaps` flag is detected or gap_closure mode is active.
</gap_closure_mode>

<revision_mode>
See `.ai/gsd/references/planner-revision.md`. Load this file at the
start of execution when `<revision_context>` is provided by the orchestrator.
</revision_mode>

<reviews_mode>
See `.ai/gsd/references/planner-reviews.md`. Load this file at the
...
- If `--gaps` flag or gap_closure context present: Read `.ai/gsd/references/planner-gap-closure.md`
- If `<revision_context>` provided by orchestrator: Read `.ai/gsd/references/planner-revision.md`
- If `--reviews` flag present or reviews mode active: Read `.ai/gsd/references/planner-reviews.md`
- If `**Mode:** quick-batch` in `<planning_context>` (#3676, epic #3344): Read `.ai/gsd/references/planner-quick-batch.md`
...
Read `.ai/gsd/references/planner-load-graph-context.md` and execute it. It checks for a
...
@.ai/gsd/references/thinking-models-planning.md
...
See @.ai/gsd/references/planner-guidance.md for return formats; gap-closure returns are artifact-based (#3440).

See @.ai/gsd/references/planner-chunked.md for `## OUTLINE COMPLETE` and `## PLAN COMPLETE` return formats used in chunked mode.
...
does not spend a revision iteration on it. Shape: `.ai/gsd/references/planner-revision.md` Step 7b)
