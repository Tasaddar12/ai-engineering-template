...
<required_reading>
@.ai/gsd/references/verification-overrides.md
@.ai/gsd/references/gates.md
@.ai/gsd/references/verifier-phase-gates.md
@.ai/gsd/references/verifier-evidence-gate.md
</required_reading>
...
@.ai/gsd/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@.ai/gsd/references/few-shot-examples/verifier.md
...
recipes: @.ai/gsd/references/verifier-wiring-patterns.md
...
@.ai/gsd/references/verifier-wiring-patterns.md
...
**When the phase under verification has `mode: mvp` in ROADMAP.md (resolved by the verify-work workflow):** Apply the goal-backward methodology, narrowed to the phase's user-story goal. Required reading: `@.ai/gsd/references/verify-mvp-mode.md`.
...
1. Top-level "User Flow Coverage" table: each step of the user story → expected → evidence in codebase → status. (Format defined in `.ai/gsd/references/verify-mvp-mode.md`.)
