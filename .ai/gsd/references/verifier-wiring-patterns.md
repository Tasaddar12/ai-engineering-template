...
Full pattern bodies for `.ai/gsd/agents/gsd-verifier.md`, extracted per
...
> These two status tables are intentionally mirrored in `.ai/gsd/agents/gsd-verifier.md`.
