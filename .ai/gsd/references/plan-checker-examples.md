...
> Progressive-disclosure reference for `.ai/gsd/agents/gsd-plan-checker.md`. The checker
> inlines this file from its `<examples>` block via `@`; the calibrated few-shot
> set lives separately in `.ai/gsd/references/few-shot-examples/plan-checker.md`.
