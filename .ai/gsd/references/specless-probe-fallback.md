...
Lazy-loaded by `.ai/gsd/workflows/plan-phase.md` step 7.95 (the gate) and the `<specless_probe_fallback>`
...
`insufficient_spec`), never a silent pass (#1154; `.ai/gsd/references/honest-verifier.md`). **Never
...
`.ai/gsd/references/prohibition-probe.md` (do not inline it). Summary:
