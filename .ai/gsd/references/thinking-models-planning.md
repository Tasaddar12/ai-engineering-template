...
This is the reasoning step that produces the rating. The taxonomy itself, the emission rules, and the anti-patterns live in @.ai/gsd/references/planner-reversibility.md — do not maintain a second classification here.
