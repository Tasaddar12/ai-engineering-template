...
- `.ai/gsd/references/thinking-models-planning.md` → Reversibility Test — the
  reasoning model that produces the rating; it consumes this taxonomy.
- `.ai/gsd/references/checkpoints.md` → `checkpoint:decision` — the checkpoint
  mechanism this feature reuses. No new checkpoint machinery is introduced.
- `.ai/gsd/references/planner-preconditions.md` — the sibling contract element
