...
`.ai/gsd/workflows/plan-phase.md` (`<review_incorporation_contract>`) and
`.ai/gsd/agents/gsd-plan-checker.md` (Review Incorporation dimension) both point back to this section for
...
`git log -1 --format=%h -- <phase_dir>/<NN>-REVIEWS.md`, after `.ai/gsd/workflows/review.md`'s REVIEWS.md
