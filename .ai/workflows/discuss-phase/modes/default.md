...
> mode flag is present (the baseline interactive flow). When `--text` is also
> present, layer that overlay from this directory on top of the rules below.
