...
See ARCHITECTURE.md and ADR-001–005. Real model/provider credentials, hosting integration and public licensing are deferred explicit configuration/release decisions, not blockers for local deterministic implementation.
