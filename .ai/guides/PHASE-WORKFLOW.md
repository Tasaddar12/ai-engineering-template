...
| [Runtime guide](../runtime/README.md) | Actual commands, configuration and recovery |
| [Template contract](../runtime/TEMPLATE-CONTRACT.md) | Additional metadata connecting full templates to the Python runner |
| [Template guide](ARTIFACT-GUIDE.md) | Artifact selection, producers, consumers and lifecycle |
...
[codebase mapper](../agents/codebase-mapper.md), then routes technical unknowns
to the [researcher](../agents/researcher.md) and claim discrepancies through
[documentation coverage](../references/documentation.md). The entry procedure
remains [onboard](../commands/onboard.md).
...
context window. Read-only [phase status](../commands/phase-status.md) starts no
...
Use the full [phase prompt template](../templates/phase-prompt.md) for
...
The [runtime contract](../runtime/TEMPLATE-CONTRACT.md) adds the metadata the
...
the coordinator using their complete [agent methods](../agents/README.md).
...
See the [runtime guide](../runtime/README.md) for exact resume, replan and
