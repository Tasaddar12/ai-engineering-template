...
REPORT = ROOT / '.ai/plans/current/PLAN-001/reviews/TASK-017-a1-c2-R1-recovery.txt'
...
with tempfile.TemporaryDirectory(prefix='TASK-017-a1-c2-R1-io-', dir=REPORT.parent) as temp:
...
'''
with tempfile.TemporaryDirectory(prefix='TASK-017-a1-c2-R1-process-', dir=REPORT.parent) as temp:
