...
def write_handoff(
    ...
    *,
    ...
    metadata.setdefault("constraints", ".ai/constraints.yaml")
    metadata.setdefault("coding_standards", ".ai/constraints.yaml#coding")
    metadata.setdefault("command_policy", ".ai/constraints.yaml#commands")
    metadata.setdefault("commands", ".ai/project/commands.yaml")
    ...
    defaults = [".ai/constraints.yaml", ".ai/models.yaml", ".ai/project/commands.yaml"]
