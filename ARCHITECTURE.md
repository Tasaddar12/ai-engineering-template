...
Current implementation scope is [PLAN-003](.ai/plans/active/PLAN-003.md). Obsolete project history and legacy data migrations are intentionally excluded from the new project. Unresolved implementation defects are recorded under `.ai/bugs/open`.
