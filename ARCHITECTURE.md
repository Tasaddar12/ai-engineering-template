...
See [package boundaries](docs/architecture/python.md), [persistence protocol](docs/state/persistence.md), [orchestration](docs/workflows/plan-implementation.md), and [ADRs](docs/decisions/README.md).
