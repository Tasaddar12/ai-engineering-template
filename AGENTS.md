...
When the user asks to discuss a phase, including "Let's discuss phase 01", load
[phase-discuss](.ai/commands/phase-discuss.md) directly and follow its phase
selection and source-search steps. Do not require a slash command or an exact
procedure name. A discussion request does not grant implementation permission.
...
implementation permission. Follow [phase authority](.ai/RULES.md#phase-authority).
